...
function HoverStat({
  ...
  return (
    <div className={`text-center ${hasHover ? 'group/stat cursor-default' : ''}`}>
      <p className={`text-xl font-bold ${numberClassName} ${hasHover ? 'transition-transform duration-200 ease-out group-hover/stat:scale-110 inline-block origin-bottom' : ''}`}>
        {number}
      </p>
...
function SmallCard({ children }: { children: React.ReactNode }) {
  return (
    <Card className="border border-gray-200 flex-1 min-w-[140px] py-0">
...
function WideCard({
  ...
  return (
    <Card className="border border-gray-200 flex-[2] min-w-[280px] py-0">
  ...
  return (
    <div className="space-y-4 mb-6">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <WideCard title="Donor Types" icon={<Home className="w-4 h-4 text-sapling" />}>
        ...
        <WideCard title="Financial Partners" icon={<Landmark className="w-4 h-4 text-sapling" />}>
        ...
        <SmallCard>
          <div className="flex flex-col items-center text-center group/stat cursor-default">
            <div className="w-8 h-8 bg-orange-50 rounded-full flex items-center justify-center mb-1.5">
              <UserPlus className="w-4 h-4 text-metric-orange" />
            </div>
            <p className="text-2xl font-bold text-metric-orange transition-transform duration-200 ease-out group-hover/stat:scale-110 inline-block origin-bottom">1,247</p>
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <WideCard title="Donor Classes" icon={<Star className="w-4 h-4 text-amber-500" />}>
        ...
        <SmallCard>
          <div className="flex flex-col items-center text-center">
            <div className="w-8 h-8 bg-green-50 rounded-full flex items-center justify-center mb-1.5">
              <Handshake className="w-4 h-4 text-sapling" />
            </div>
        ...
        <WideCard title="Donor Status" icon={<Users className="w-4 h-4 text-sapling" />}>
