...
import { Mail, Phone, Calendar, Pencil, Sparkles, Plus } from "lucide-react"
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <Button variant="ghost" size="sm" className="gap-2 text-sapling hover:text-sapling-accent hover:bg-sapling-light/10">
