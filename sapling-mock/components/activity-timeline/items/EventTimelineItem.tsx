        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600">
              <span className="font-medium">Ticket:</span> {item.ticket}{" "}
              <span className="font-medium ml-2">Table:</span> {item.table}{" "}
              <span className="font-medium ml-2">Guests:</span> {item.guests}
            </p>
